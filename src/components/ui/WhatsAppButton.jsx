 ...
 * Renders in the bottom-right corner on all pages.
 */
...
export default function WhatsAppButton({ number }) {
  const href = `https://wa.me/${number}?text=Hi%20Stravon%20Media!%20I'm%20interested%20in%20your%20services.`;
  ...
  return (
    <a
      ...
      aria-label="Chat with Stravon Media on WhatsApp"
      style={{
        position: 'fixed',
        bottom: '24px',
        right: '24px',
    ...
    >
      ...
      <span style={{
        ...
        animation: 'pulseRing 2s cubic-bezier(0.215, 0.61, 0.355, 1) 0.5s infinite',
      }} />
      {WHATSAPP_ICON}
    </a>
  );
